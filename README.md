...
<h3 align="center">Full-Stack Developer | AI/ML Builder | CS @ BMS College of Engineering</h3>

<p align="center">
  <img src="https://komarev.com/ghpvc/?username=ShreyasShetty2604&label=Profile%20views&color=0e75b6&style=flat" alt="ShreyasShetty2604" />
</p>

- 🎓 CS student at **BMS College of Engineering**, Bangalore
- 🌱 Currently learning **Advanced Machine Learning • System Design • DevOps & Cloud Scaling • AI Agent Automation**
- 💬 Ask me about **React & Modern Frontend • Motion UI (GSAP) • Building business websites • AI integrations**
- 🏆 Hackathon regular — recent builds span reverse-logistics platforms, gamified fitness apps, and ML-driven route analysis
- 📫 Reach me at **shettyshreyas2604@gmail.com**
- ⚡ Fun fact: **I think I turn caffeine into code**
...
**🏃 Stride Quest** — *Turf War meets Strava*
A gamified territorial running app where your runs claim real-world territory.
`Expo / React Native` · `Supabase + PostGIS` · `S2 Geometry`

**📦 Amazon Relay** — *Built for Amazon HackOn 2026*
A recommerce & reverse-logistics platform with a distinctive "warm brutalism" UI — deliberately unlike a typical Amazon product.
`Product Design` · `LaTeX PRD` · `Fraunces + DM Sans`

**💰 UpSyde** — *Fidelity Hackathon*
An investment intelligence platform pairing a React frontend with a FastAPI backend.
`React` · `FastAPI`

**🐛 Traceback** — *AI-Powered Debugging*
A debugging assistant using vector similarity search to surface fixes from past errors.
`Vector Search` · `Python`

**🛰️ Route Resilience** — *Bharatiya Antariksh Hackathon*
